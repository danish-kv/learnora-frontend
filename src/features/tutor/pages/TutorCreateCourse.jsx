...
const TutorCreateCourse = () => {
  ...
  const handleOnSubmit = async (values, actions) => {
    ...
    formData.append("rental_price", values.rentalPrice ? values.rentalPrice : '');
    formData.append("rental_duration", values.rentalDuration ? values.rentalDuration : '');
        ...
        >
          {({ setFieldValue, isSubmitting, values }) => (
            <Form className="bg-white p-6 rounded-lg shadow-md">
              ...
              {/* <div className="mb-4 flex gap-4">
                <div className="flex-1">
                  <label htmlFor="isRental" className="block text-gray-700 mb-2">
                    Course rental option?
                  </label>
                  <Field
                    type="checkbox"
                    name="isRental"
