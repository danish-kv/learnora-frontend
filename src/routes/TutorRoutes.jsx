...
const TutorRegister = lazy(() => import("../features/tutor/pages/TutorRegister"));
const TutorLogin = lazy(() => import("../features/tutor/pages/TutorLogin"));
const TutorApplication = lazy(() => import("../features/tutor/pages/TutorApplication"));
const TutorDashboard = lazy(() => import("../features/tutor/pages/TutorDashboard"));
...
const TutorCourseDetails = lazy(() => import("../features/tutor/pages/TutorCourseDetails"));
const TutorApplicationDone = lazy(() => import("../features/tutor/pages/TutorApplicationDone"));
const TutorEditCourse = lazy(() => import("../features/tutor/pages/TutorEditCourse"));
const TutorCreateCourse = lazy(() => "../features/tutor/pages/TutorCreateCourse");
const TutorCreateModule = lazy(() => import("../features/tutor/pages/TutorCreateModule"));
const TutorEditModule = lazy(() => import("../features/tutor/pages/TutorEditModule"));
